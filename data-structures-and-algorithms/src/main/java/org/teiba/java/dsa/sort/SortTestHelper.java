...
public class SortTestHelper {
    ...
    /**
     * 测试clazz所对应的排序算法排序arr数组所得到结果的正确性和算法运行时间
     *
     * @param clazz
     * @param arr
     */
    public static void testSort(Class clazz, String methodName, Class argClass, Comparable[] arr) {
        
        // 通过Java的反射机制，通过排序的类名，运行排序函数
        try {
            // 通过排序函数的Class对象获得排序方法
            Method sortMethod = clazz.getMethod(methodName, argClass);
            // 排序参数只有一个，是可比较数组arr
